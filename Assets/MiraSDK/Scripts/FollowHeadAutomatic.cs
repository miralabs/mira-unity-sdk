...
namespace Mira
{
    ...
    /// </summary>
    public class FollowHeadAutomatic : MonoBehaviour
    {
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public Vector3 headFollowPositionCM = new Vector3(0f, 0f, 100f);
        ...
        private void Start()
        {
            ...
            headFollowPositionCM *= (1 / MiraArController.scaleMultiplier);
        ...
        {
            return head.position + (head.rotation * headFollowPositionCM);
        }
